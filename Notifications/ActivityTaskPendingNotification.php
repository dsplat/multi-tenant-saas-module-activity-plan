...
namespace MultiTenantSaas\Modules\ActivityPlan\Notifications;
...
/**
 * 活动任务待确认通知（docs/event-plan.md Phase 0）
 *
 ...
 */
class ActivityTaskPendingNotification extends Notification
{
    public function __construct(
        private readonly ActivityTask $task,
        private readonly ActivityPlan $plan,
    ) {}
